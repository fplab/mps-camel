...
<model ref="r:dcb9e28c-9136-4762-9e0d-55f443a56c7d(camel.intentions)">
  ...
  <node concept="2ZfgGJ" id="lrWAqeF_$I">
    <property role="TrG5h" value="LetBody" />
      ...
      <node concept="3clFbS" id="lrWAqeF_$K" role="2VODD2">
        <node concept="3clFbF" id="lrWAqeF_Su" role="3cqZAp">
          <node concept="Xl_RD" id="lrWAqeF_DF" role="3clFbG">
            <property role="Xl_RC" value="let __ = __ in &lt;SEL&gt;" />
          </node>
        </node>
      </node>
    </node>
    <node concept="2Sbjvc" id="lrWAqeF_$L" role="2ZfgGD">
      <node concept="3clFbS" id="lrWAqeF_$M" role="2VODD2">
        ...
        <node concept="3cpWs8" id="lrWAqfCTdJ" role="3cqZAp">
          <node concept="3cpWsn" id="lrWAqfCTdM" role="3cpWs9">
            <property role="TrG5h" value="x" />
            <node concept="3Tqbb2" id="lrWAqfCTdH" role="1tU5fm">
              <ref role="ehGHo" to="kkzo:7g7qneGHiTC" resolve="LetVariable" />
            </node>
            <node concept="2ShNRf" id="lrWAqfCTfz" role="33vP2m">
              <node concept="3zrR0B" id="lrWAqfCTfx" role="2ShVmc">
                <node concept="3Tqbb2" id="lrWAqfCTfy" role="3zrR0E">
                  <ref role="ehGHo" to="kkzo:7g7qneGHiTC" resolve="LetVariable" />
                </node>
              </node>
            </node>
        ...
        <node concept="3clFbF" id="lrWAqfChsK" role="3cqZAp">
          <node concept="2OqwBi" id="lrWAqfCVrk" role="3clFbG">
            <node concept="2OqwBi" id="lrWAqfChA_" role="2Oq$k0">
              <node concept="37vLTw" id="lrWAqfChsI" role="2Oq$k0">
                <ref role="3cqZAo" node="lrWAqeF_T8" resolve="result" />
              </node>
              <node concept="3Tsc0h" id="lrWAqfChC4" role="2OqNvi">
                <ref role="3TtcxE" to="kkzo:7g7qneGHqWK" resolve="variable" />
              </node>
            </node>
            <node concept="TSZUe" id="lrWAqfCXRJ" role="2OqNvi">
              <node concept="37vLTw" id="lrWAqfCY6I" role="25WWJ7">
                <ref role="3cqZAo" node="lrWAqfCTdM" resolve="x" />
              </node>
            </node>
          </node>
        </node>
        <node concept="3clFbF" id="lrWAqeFAuZ" role="3cqZAp">
          <node concept="37vLTI" id="lrWAqeFB09" role="3clFbG">
            ...
            <node concept="2OqwBi" id="lrWAqeFACx" role="37vLTJ">
              ...
              <node concept="3TrEf2" id="lrWAqf_skx" role="2OqNvi">
  ...
  <node concept="2ZfgGJ" id="lrWAqfLSeV">
    <property role="TrG5h" value="IfElse" />
    <ref role="2ZfgGC" to="kkzo:3vh6UvnV9zD" resolve="LambdaExpression" />
    <node concept="2S6ZIM" id="lrWAqfLSeW" role="2ZfVej">
      <node concept="3clFbS" id="lrWAqfLSeX" role="2VODD2">
        <node concept="3clFbF" id="lrWAqfLSoS" role="3cqZAp">
          <node concept="Xl_RD" id="lrWAqfLSoR" role="3clFbG">
            <property role="Xl_RC" value="if __ then __ else &lt;SEL&gt;" />
          </node>
        </node>
      </node>
    </node>
    <node concept="2Sbjvc" id="lrWAqfLSeY" role="2ZfgGD">
      <node concept="3clFbS" id="lrWAqfLSeZ" role="2VODD2">
        <node concept="3cpWs8" id="lrWAqfSQec" role="3cqZAp">
          <node concept="3cpWsn" id="lrWAqfSQed" role="3cpWs9">
            <property role="TrG5h" value="result" />
            <node concept="3Tqbb2" id="lrWAqfSQee" role="1tU5fm">
              <ref role="ehGHo" to="kkzo:3HIm0ir345l" resolve="IfExpression" />
            </node>
            <node concept="2ShNRf" id="lrWAqfSQef" role="33vP2m">
              <node concept="3zrR0B" id="lrWAqfSQeg" role="2ShVmc">
                <node concept="3Tqbb2" id="lrWAqfSQeh" role="3zrR0E">
                  <ref role="ehGHo" to="kkzo:3HIm0ir345l" resolve="IfExpression" />
                </node>
              </node>
            </node>
        ...
        <node concept="3clFbF" id="lrWAqfSQei" role="3cqZAp">
          <node concept="2OqwBi" id="lrWAqfSQej" role="3clFbG">
            <node concept="2Sf5sV" id="lrWAqfSQek" role="2Oq$k0" />
            <node concept="1P9Npp" id="lrWAqfSQel" role="2OqNvi">
              <node concept="37vLTw" id="lrWAqfSQem" role="1P9ThW">
                <ref role="3cqZAo" node="lrWAqfSQed" resolve="result" />
              </node>
            </node>
          </node>
        </node>
        <node concept="3clFbF" id="lrWAqfSQen" role="3cqZAp">
          <node concept="37vLTI" id="lrWAqfSRoy" role="3clFbG">
            <node concept="2Sf5sV" id="lrWAqfSRr8" role="37vLTx" />
            <node concept="2OqwBi" id="lrWAqfSQep" role="37vLTJ">
              <node concept="37vLTw" id="lrWAqfSQeq" role="2Oq$k0">
                <ref role="3cqZAo" node="lrWAqfSQed" resolve="result" />
              </node>
              <node concept="3TrEf2" id="lrWAqfSR4P" role="2OqNvi">
