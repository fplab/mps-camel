...
<model ref="r:3ed5e461-de7e-409a-b714-afd8cf19d5d0(camel.editor)">
  ...
  <node concept="24kQdi" id="1Foaqqimw_u">
    ...
    <node concept="1WcQYu" id="33sWCbCXcS0" role="2wV5jI">
      ...
      <node concept="3EZMnI" id="33sWCbCXetg" role="1LiK7o">
        ...
        <node concept="1Lj6DL" id="33sWCbCXet$" role="3EZMnx">
          <node concept="1Lj6DC" id="33sWCbCXetA" role="1Lj8FM">
            <node concept="3clFbS" id="33sWCbCXetC" role="2VODD2">
              <node concept="3clFbF" id="5jedEAj8$uI" role="3cqZAp">
                <node concept="2OqwBi" id="5jedEAj8$PJ" role="3clFbG">
                  <node concept="1Lj6YZ" id="5jedEAj8$uH" role="2Oq$k0" />
                  <node concept="3n3YKJ" id="5jedEAj8AM8" role="2OqNvi" />
                </node>
              </node>
            </node>
          </node>
        ...
        <node concept="2iRfu4" id="33sWCbCXetj" role="2iSdaV" />
      </node>
    </node>
  </node>
  ...
  <node concept="24kQdi" id="4ibC_jHJWBr">
    ...
    <node concept="1WcQYu" id="5jedEAjjdtl" role="2wV5jI">
      <node concept="2ElW$n" id="5jedEAjjdtm" role="2El2Yn">
        <node concept="2OqwBi" id="5jedEAjotCo" role="2EmURo">
          <node concept="2EmZKS" id="5jedEAjotpd" role="2Oq$k0" />
          <node concept="2qgKlT" id="5jedEAjou2I" role="2OqNvi">
            <ref role="37wK5l" to="ysy1:5jedEAjot9R" resolve="getPriority" />
          </node>
        </node>
      </node>
      <node concept="3EZMnI" id="5jedEAjjdtv" role="1LiK7o">
        <node concept="3EZMnI" id="5jedEAjkkZ5" role="3EZMnx">
          <node concept="VPM3Z" id="5jedEAjkkZ7" role="3F10Kt" />
          ...
          <node concept="3EZMnI" id="5jedEAjwtC$" role="3EZMnx">
            ...
            <node concept="l2Vlx" id="5jedEAjwtCD" role="2iSdaV" />
          </node>
          <node concept="l2Vlx" id="5jedEAjvhwe" role="2iSdaV" />
        </node>
        ...
        <node concept="2iRkQZ" id="5jedEAjkkYO" role="2iSdaV" />
      </node>
    </node>
  </node>
    ...
    <node concept="1Lj6DL" id="lrWAqe_rSh" role="2wV5jI">
      <node concept="1Lj6DC" id="lrWAqe_rSj" role="1Lj8FM">
        <node concept="3clFbS" id="lrWAqe_rSl" role="2VODD2">
          <node concept="3clFbF" id="lrWAqeCCfh" role="3cqZAp">
            <node concept="2OqwBi" id="lrWAqeCCyz" role="3clFbG">
              <node concept="1Lj6YZ" id="lrWAqeCCfg" role="2Oq$k0" />
              <node concept="3n3YKJ" id="lrWAqeCCUK" role="2OqNvi" />
            </node>
          </node>
        </node>
      </node>
  ...
  <node concept="24kQdi" id="lrWAqeCAJH">
    <ref role="1XX52x" to="kkzo:lrWAqeCAJG" resolve="Sqrt" />
    <node concept="1Lj6DL" id="lrWAqeCAJJ" role="2wV5jI">
      <node concept="1Lj6DC" id="lrWAqeCAJL" role="1Lj8FM">
        <node concept="3clFbS" id="lrWAqeCAJN" role="2VODD2">
          <node concept="3clFbF" id="lrWAqeCAOt" role="3cqZAp">
            <node concept="2OqwBi" id="lrWAqeCBcV" role="3clFbG">
              <node concept="1Lj6YZ" id="lrWAqeCATF" role="2Oq$k0" />
              <node concept="3n3YKJ" id="lrWAqeCBWC" role="2OqNvi" />
            </node>
          </node>
        </node>
      </node>
      <node concept="Vb9p2" id="lrWAqeCAOo" role="3F10Kt" />
    </node>
  </node>
  <node concept="24kQdi" id="lrWAqeDEHp">
    <ref role="1XX52x" to="kkzo:lrWAqeDEHo" resolve="Pow" />
    <node concept="1Lj6DL" id="lrWAqeDEHr" role="2wV5jI">
      <node concept="1Lj6DC" id="lrWAqeDEHt" role="1Lj8FM">
        <node concept="3clFbS" id="lrWAqeDEHv" role="2VODD2">
          <node concept="3clFbF" id="lrWAqeDEM9" role="3cqZAp">
            <node concept="2OqwBi" id="lrWAqeDF5r" role="3clFbG">
              <node concept="1Lj6YZ" id="lrWAqeDEM8" role="2Oq$k0" />
              <node concept="3n3YKJ" id="lrWAqeDGc3" role="2OqNvi" />
            </node>
          </node>
        </node>
      </node>
      <node concept="Vb9p2" id="lrWAqeDEM4" role="3F10Kt" />
    </node>
  </node>
</model>
